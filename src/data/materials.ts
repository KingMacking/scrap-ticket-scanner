...
export const MATERIALS = [
  ...
  { id: '6',  name: 'Radiador Mixto', defaultPrice: 1500,  aliases: ['radiador mixto', 'rad mixto', 'radmix'],                orderIndex: 6  },
  { id: '7',  name: 'Bateria',        defaultPrice: 400,   aliases: ['bateria', 'batería', 'bater', 'bat'],                   orderIndex: 7  },
  { id: '8',  name: 'Bateria chica',  defaultPrice: 300,   aliases: ['bateria chica', 'bat chica', 'batchica'],               orderIndex: 8  },
